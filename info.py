...
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://techybishal27:<db_password>@reconic-movies.9fla3.mongodb.net/?retryWrites=true&w=majority&appName=reconic-movies")
